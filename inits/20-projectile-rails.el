...
;; (define-key projectile-rails-mode-map (kbd "s-M-m")   'projectile-rails-find-current-model)
;; (define-key projectile-rails-mode-map (kbd "s-M-c")   'projectile-rails-find-current-controller)
